...
LEFT JOIN table_HIST h ON a.primaryid = h."識別番号";

-- node_002: DRUG -> count per primaryid (服薬数)
...
LEFT JOIN jader_drug_counts c USING (primaryid);
```
...
LEFT JOIN table_OUTC o ON a.primaryid = o.primaryid;

-- number_of_drug per primaryid
...
LEFT JOIN faers_drug_counts c USING (primaryid);
```
