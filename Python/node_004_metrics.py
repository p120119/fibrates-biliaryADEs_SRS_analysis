...
# --- Convert MSI DataFrames to pandas ---
...
# --- Fisher's exact test and p-value calculation ---
p_values = []
...
IC, IC025, IC975 = [], [], []
# nplus1 and nplusplus are scalars (shared across all rows), so use them directly inside the loop
